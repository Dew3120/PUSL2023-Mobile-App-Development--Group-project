...
class _CartPaymentScreenState extends State<CartPaymentScreen> {
  ...
  Future<void> _pay() async {
    ...
    final itemCount = _cartService.items.fold(0, (sum, item) => sum + item.quantity);
    ...
    showDialog(
      ...
      builder: (_) => _CartSuccessDialog(itemCount: itemCount),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final totalFormatted = '£${_cartService.cartTotal.toStringAsFixed(0)}';
          ...
          child: Column(
            ...
            children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'QTY: ${item.quantity}  •  ${p.collection.toUpperCase().replaceAll('_', ' ')}',
                              style: TextStyle(
                                fontSize: 10,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _totalRow('Subtotal', totalFormatted),
                    const SizedBox(height: 6),
...
class _CartSuccessDialog extends StatelessWidget {
  final int itemCount;
  const _CartSuccessDialog({required this.itemCount});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Thank you. Your order containing $itemCount item(s) has been received. '
